...
public class StatsRessourceTest {
	...
	public void shouldGetNumberOfPatientsByStatusWhenIsOk() throws Exception {
		...
		final List<PatientsByStatusDTO> patientsByStatuss = Arrays.asList(patientsPerDietDTO);
		
		// When
		when(statsService.findNumberOfPatientsByStatus()).thenReturn(patientsByStatuss);
	...
	public void shouldGetNumberOfPatientsByStatusWhenIsEmpty() throws Exception {
		// Given
		final List<PatientsByStatusDTO> patientsByStatuss = Collections.emptyList();
